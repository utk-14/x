...
const GAME_URL = "http://localhost:5177";
  ...
  return (
    <div className="page-backdrop min-h-screen px-4 py-10 sm:px-6 md:px-10 xl:px-16">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <div className="rounded-[2rem] border border-amber-200/90 bg-white/95 p-8 shadow-xl shadow-amber-100/50 backdrop-blur-xl dark:border-slate-600/50 dark:bg-slate-900/85">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="max-w-xl font-dyslexic text-base text-slate-600 dark:text-slate-300">
                Start Balloon app on port 5177 if the frame is empty.
              </p>
            </div>
          ...
          <div className="mt-6 rounded-3xl border border-slate-200/80 bg-slate-50/90 p-4 text-sm text-slate-700 dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-300">
            <p className="font-dyslexic text-sm">
              Start Balloon app: <code className="rounded bg-slate-100 px-1 py-0.5 dark:bg-slate-800">cd /home/sanvi/Music/B/balloon_game && npm run dev -- --port 5177</code>
            </p>
          </div>
        </div>
      </div>
